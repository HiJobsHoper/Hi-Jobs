...
public class KelolaProfil extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
            ...
            public void onClick(View v) {
                ...
                if (!Pass_Lama.equals("") || !Pass_Baru.equals("") || !PassKon_Baru.equals("")) {
                    ...
                    if (cek_KelPro(Nama,Tanggal,Nomor,Email,Alamat,Keahlian,Pengalaman,
                        ...
                        if (UserId == "") {
                            Toast.makeText(KelolaProfil.this, "Akun belum ada", Toast.LENGTH_SHORT).show();
                        } else {
        ...
        firebaseUser.reauthenticate(authCredential).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                if (task.isSuccessful()) {
                    ...
                    Toast.makeText(KelolaProfil.this, "Kata sandi lama tidak sesuai",
    ...
    public void setData(String Nama,String Jenis,String Tanggal,String Nomor,String Email,
        ...
        databaseReference.child(UserId).child("Jenis Kelamin").setValue(Jenis);
        databaseReference.child(UserId).child("Tanggal Lahir").setValue(Tanggal);
        databaseReference.child(UserId).child("Nomor Telepon").setValue(Nomor);
        databaseReference.child(UserId).child("Email").setValue(Email);
        databaseReference.child(UserId).child("Pendidikan Terakhir").setValue(Pendidikan);
        databaseReference.child(UserId).child("Alamat").setValue(Alamat);
        databaseReference.child(UserId).child("Keahlian").setValue(Keahlian);
        databaseReference.child(UserId).child("Pengalaman Kerja").setValue(Pengalaman);
        databaseReference.child(UserId).child("Kewarganegaraann").setValue(Kewarganegaraan)
